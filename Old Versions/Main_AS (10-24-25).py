...
#Changelog:
    #Fixed errors with request function rawindex and too few elements in last r and last c
    #Shortened blocking time for send and recieve
...
s.setblocking() #SOme blocking may be good. I want the code to wait for data, but not to wait when sending. Maybe there is a good medium here.
s.settimeout(0.05) #I think redundant to have setblocking, but this sets the timeout limit for blocking sockets
    ...
    try:
        ...
        while res[1] < MsToi: #Exceed the time of interest by at least 1 ms    
            ...
            if res[0] != 0:
                ...
                diff = MsToi - res[1]
                if (abs(diff) > 10000) | (res[0] != wnoToi) :
