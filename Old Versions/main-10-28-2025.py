...
wdt = WDT(timeout=20000) #Timeout function; triggers if no data is sent within timeout threshold
...
def clear_wifi_rx_buffer(sock):      
    ...
    try:
        ...
        print("Error during wifi buffer clear:", e)
...
info_packet = (1, V_NUM, mac_id, ip_last_byte, 0, 0, 0, 0, 0, 0) # This tells me when the board restarted how long it took to reach the main loop since booting
packet = data_packing(send_packet_format, info_packet)
s.send(packet)
